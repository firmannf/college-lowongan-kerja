                                ...
                                <div class="card">
                                    ...
                                    <div class="content table-responsive table-full-width">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                    $strQuery = "SELECT la.lamaran_id, la.lowongan_id, cp.calon_pekerja_nama_lengkap, la.lamaran_status_lolos
                                                    ...
                                                    $m = 0;
                                                    while($result = mysqli_fetch_assoc($query)){
                                                        echo "<td>$result[calon_pekerja_nama_lengkap]</td>";echo "</td>";
                                                        echo "<td>$result[lamaran_status_lolos]</td>";echo "</td>";
                                                        echo "<td><a href=# data-toggle=modal data-target=#editstatus$m>Edit</a></td>";
                                                        echo "</tr>";
                                                ?>
